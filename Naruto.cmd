...
trigger1 = ctrl
;---------------------------------------------------------------------------
; Sempou Cho Oodama Rasengan
[State -1, Sempou Cho Oodama Rasengan]
type = ChangeState
Triggerall = var(2) = 0 && var(3) = 0 && var(4) = 0
...
;---------------------------------------------------------------------------
; Cho Oodama Rasenrengan
[State -1, Cho Oodama Rasenrengan]
type = ChangeState
Triggerall = var(2) = 1
Triggerall = power >= 2000
value = 2700
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; Twin Mini Rasenshuriken
[State -1, Twin Mini Rasenshuriken]
type = ChangeState
Triggerall = var(2) = 1
Triggerall = power >= 1000
Triggerall = numhelper(2715) = 0
Triggerall = numhelper(2717) = 0
value = 2710
triggerall = command = "holddown"
triggerall = command = "b"
trigger1 = statetype != A
...
[State -1, Cho Oodama Rasen Tarengan]
type = ChangeState
Triggerall = var(2) = 1
Triggerall = power >= 3000
value = 2720
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; Mini Wakusei Rasengan
[State -1, Mini Wakusei Rasengan]
type = ChangeState
Triggerall = var(2) = 1
Triggerall = power >= 1000
value = 2750
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; Bunshin Bijuu Senkoodan
[State -1, Bunshin Bijuu Senkoodan]
type = ChangeState
Triggerall = var(2) = 1
Triggerall = power >= 500
value = 2770
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; Mini Rasenshuriken Tarengan
[State -1, Mini Rasenshuriken Tarengan]
type = ChangeState
Triggerall = var(2) = 1
Triggerall = numhelper(2825) = 0
triggerall = power >= 2000
value = 2820
triggerall = command = "Kage Bunshin no Jutsu"
trigger1 = statetype != A
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; Wakusei Rasengan Aéreo
[State -1, Wakusei Rasengan Aéreo]
type = ChangeState
Triggerall = pos y <= -10
Triggerall = var(2) = 1
Triggerall = power >= 1500
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; Dai Cho Oodama Rasenshuriken Aéreo
[State -1, Dai Cho Oodama Rasenshuriken Aéreo]
type = ChangeState
triggerall = pos y <= -10
Triggerall = var(2) = 1
Triggerall = power >= 3000
